namespace SAE_Semestre_2
{
    partial class FormSupprimerStation
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnSupprimerStation
            // 
            btnSupprimerStation.Location = new Point(388, 385);
            btnSupprimerStation.Margin = new Padding(3, 4, 3, 4);
            btnSupprimerStation.Name = "btnSupprimerStation";
            btnSupprimerStation.Size = new Size(154, 31);
            ...
            btnSupprimerStation.Click += btnSupprimerStation_Click;
            // 
            // txtNomStationSuppr
            // 
            txtNomStationSuppr.Location = new Point(309, 247);
            txtNomStationSuppr.Margin = new Padding(3, 4, 3, 4);
            txtNomStationSuppr.Name = "txtNomStationSuppr";
            txtNomStationSuppr.Size = new Size(310, 27);
            txtNomStationSuppr.TabIndex = 21;
            txtNomStationSuppr.TextChanged += txtNomStationSuppr_TextChanged;
            // 
            // lblNomStationSuppr
            // 
            lblNomStationSuppr.AutoSize = true;
            lblNomStationSuppr.Location = new Point(309, 223);
            lblNomStationSuppr.Name = "lblNomStationSuppr";
            lblNomStationSuppr.Size = new Size(130, 20);
            ...
            Load += FormSupprimerStation_Load;
            ResumeLayout(false);
            PerformLayout();
        }
